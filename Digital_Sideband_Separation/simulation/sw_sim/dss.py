...
def calibrate_weights(cal1_data, cal2_data, lo_freq, amp_sig,fft_len, fs):
...
def evaluate_data(test1_data, test2_data, usb_w,lsb_w, lo_freq,amp_sig,fft_len,fs):
...
#second lo
lo = 103.8
usb_w, lsb_w = calibrate_weights(cal3,cal4, lo,amp_sig, fft_size,fs)
#ideal weigths over the 

cal_usb_ideal, cal_lsb_ideal, cal_srr_lsb_ideal, cal_srr_usb_ideal = evaluate_data(cal3,
        cal4,ideal_w,ideal_w, lo, amp_sig, fft_size,fs)
...
test_usb_ideal, test_lsb_ideal, test_srr_lsb_ideal, test_srr_usb_ideal = evaluate_data(test3,
        test4,ideal_w,ideal_w, lo, amp_sig, fft_size,fs)
