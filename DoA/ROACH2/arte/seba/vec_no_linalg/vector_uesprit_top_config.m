...
function vector_uesprit_top_config(this_block)
  ...
  this_block.addGeneric('ACC_WIDTH','integer','24');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  path = '/home/seba/Workspace/simulink_models/DoA/ROACH2/arte/seba/no_linalg/';
  ...
  %this_block.addFile('vector_uesprit_top.v');
