...
function scalar_uesprit_top_config(this_block)

  % Revision History:
  %
  %   23-Apr-2021  (22:26 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /home/seba/Workspace/simulink_models/DoA/ROACH2/arte/seba/sca_no_linalg/scalar_uesprit_top.v
  %
  %

  this_block.setTopLevelLanguage('Verilog');

  this_block.setEntityName('scalar_uesprit_top');
  ...
  this_block.addGeneric('ACC_WIDTH','integer','18');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  path = '/home/seba/Workspace/simulink_models/DoA/ROACH2/arte/seba/sca_no_linalg/';
  %this_block.addFile('scalar_uesprit_top.v');
  this_block.addFile(strcat(path, 'hdl_codes/centrosym_matrix.v' ));
  this_block.addFile(strcat(path, 'hdl_codes/correlation_mults.v'));
  this_block.addFile(strcat(path, 'hdl_codes/dsp48_mult.v'));
  this_block.addFile(strcat(path, 'hdl_codes/complex_power.v'));
  this_block.addFile(strcat(path, 'hdl_codes/complex_mult.v'));
  this_block.addFile(strcat(path, 'hdl_codes/signed_cast.v'));
  this_block.addFile(strcat(path, 'hdl_codes/signed_acc.v'));
  this_block.addFile(strcat(path, 'hdl_codes/unsig_acc.v'));
  this_block.addFile(strcat(path, 'hdl_codes/scalar_uesprit.v'));
  this_block.addFile(strcat(path, 'scalar_uesprit_top.v'));
