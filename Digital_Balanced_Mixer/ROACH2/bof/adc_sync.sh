synchronize_adc5g.py \
    ...
    --crossbramsreal dout_ab_re0 dout_ab_re1 dout_ab_re2 dout_ab_re3 dout_ab_re4 dout_ab_re5 dout_ab_re6 dout_ab_re7\
    --crossbramsimag dout_ab_im0 dout_ab_im1 dout_ab_im2 dout_ab_im3 dout_ab_im4 dout_ab_im5 dout_ab_im6 dout_ab_im7\
    --addrwidth 8\
    --datawidth 64\
    --bandwidth 1080\
    --countreg cnt_rst\
