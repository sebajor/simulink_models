...
upload     = False
program    = False
boffile    = 'bm_2048ch_1080mhz.bof.gz'
...
lo_sources      = [{'type'       : 'sim',
                    ...
                    'def_power'  : 10,      # dBm
                    'lo_freqs'   : [0]}] # MHz
                    #'lo_freqs'   : [2000, 2100, 2200, 2300, 2400, 2500, 2600]}] # MHz
pause_time      = 1e-10
...
# BM settings
saved_params         = {'use_saved' : False, 'datadir' : 'bm_noise_test dss_2048ch_1080mhz 2019-09-25 15:53:54.tar.gz'} 
cal_method           = 'Ideal'
ideal_const          = 1
cal_chnl_step        = 8
syn_chnl_step        = 8
...
const_brams_info2 = {'addr_width'      : 8,
                     'word_width'      : 32,
                     'data_type'       : '>i4',
                     'deinterleave_by' : 8,
                     'bram_names'      :
