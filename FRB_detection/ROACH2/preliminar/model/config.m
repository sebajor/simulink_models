...
rfi_corr_dout_shift = 2;    %%the input is acc_width, cmult_point
rfi_corr_dout_width = 16;
rfi_corr_dout_point = 14;
...
rfi_pow_pow_shift = 2;     %%the input is 2*rfi_width_2*rfi_point
rfi_pow_pow_conv_width = 18;
rfi_pow_pow_conv_point = 15;
rfi_pow_acc_width = 32;
rfi_pow_post_acc_dly = rfi_corr_post_acc_dly;
rfi_pow_dout_width = 16;
rfi_pow_dout_point = 14;
...
set_param(name, 'pow_shift', num2str(rfi_pow_pow_shift));
set_param(name, 'pow_conv_width', num2str(rfi_pow_pow_conv_width));
set_param(name, 'pow_conv_point', num2str(rfi_pow_pow_conv_point));
