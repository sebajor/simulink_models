...
/* This codes are used to read the DRAM data. The DRAM data is in encoded in 4bits and the basic unit for a computer is a byte
 * So, this code transform the data from 4bits to a char
 */
