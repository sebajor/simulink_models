...
function moving_average_config(this_block)

  % Revision History:
  %
  %   18-Mar-2022  (10:24 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /home/roach/Workspace/simulink_models/FRB_Detection/ROACH2/preliminar/v3/model/rtl/moving_average.v
  %
  %

  this_block.setTopLevelLanguage('Verilog');

  this_block.setEntityName('moving_average');
  ...
  win_len = str2num(get_param(bb_mask, 'win_size'));
  ...
  this_block.addGeneric('DIN_POINT','integer', num2str(din_point));
  this_block.addGeneric('WINDOW_LEN','integer',num2str(win_len));
  this_block.addGeneric('DOUT_WIDTH','integer',num2str(dout_width));
  this_block.addGeneric('APPROX','string','"truncate"');
  ...
  this_block.addFile('rtl/moving_average.v');
