...
def calibrate_adc(roach_ip, gen_ip, bw, gen_freq=10, gen_pow=-3,load=0,
    ...
    adccal0 = ADCCalibrate(roach=roach, roach_name="", zdok=0,
            ...
            clockrate=bw)
    adccal1 = ADCCalibrate(roach=roach, roach_name="", zdok=0,
