...
function arcsin_config(this_block)

  % Revision History:
  %
  %   30-Dec-2020  (15:30 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /home/franco/Diego/Doa_ordenado/arcsin.v
  %
  %

  this_block.setTopLevelLanguage('Verilog');

  this_block.setEntityName('arcsin');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('din').width ~= 13);
      this_block.setError('Input data type for port "din" must have width=13.');
    end
  ...
  this_block.addGeneric('FILENAME','string','"/home/seba/Workspace/simulink_models/FRB_Detection/ROACH2/work_in_progress/doa/hdl_codes/arcsin_hex.mem"');
