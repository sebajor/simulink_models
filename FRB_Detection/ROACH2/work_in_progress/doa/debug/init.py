...
phase_brams = ['phase4', 'phase5']  ##que malos nombres
...
def read_phases(fpga):
    brams = ["phase4", "phase5"]
    phase0, phase1 = calan.read_deinterleave_data(fpga, brams[0],2,10,16,'>i2')
    phase2, phase3 = calan.read_deinterleave_data(fpga, brams[1],2,10,16,'>i2')
...
dat0, dat1 = calan.read_deinterleave_data(roach, 'phase0_cont',2,11,16,'>i2')
dat2, dat3 = calan.read_deinterleave_data(roach, 'phase0_cont1',2,11,16,'>i2')
