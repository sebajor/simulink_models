...
function gps_parser_config(this_block)
  ...
  this_block.addGeneric('MEM_FILE','string','"/home/franco/seba/frb_stable/hdl_codes/gold_hex.mem"');
  ...
  this_block.addFile(strcat(dir,'gold_hex.mem'));
  this_block.addFile(strcat(dir,'gpszda.mem'));
  this_block.addFile(strcat(dir,'uart_tx.v'));
  this_block.addFile(strcat(dir,'uart_rx.v'));
  this_block.addFile(strcat(dir,'pattern_search.v'));
  this_block.addFile(strcat(dir,'send_msg.v'));
  this_block.addFile(strcat(dir,'gps_parser.v'));
