...
function pkt_gen_top_config(this_block)

  % Revision History:
  %
  %   08-Mar-2022  (18:26 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /home/seba/Workspace/simulink_models/One_Gbe/ROACH2/packet_test/pkt_gen_top.v
  %
  %

  this_block.setTopLevelLanguage('Verilog');

  this_block.setEntityName('pkt_gen_top');
  ...
  this_block.addSimulinkInport('sleep_write');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('sleep_write').width ~= 32);
      this_block.setError('Input data type for port "sleep_write" must have width=32.');
    end
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('rtl/pkt_gen.v');
  this_block.addFile('pkt_gen_top.v');
return;
