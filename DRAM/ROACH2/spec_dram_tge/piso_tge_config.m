...
function piso_tge_config(this_block)

  % Revision History:
  %
  %   12-Nov-2020  (18:39 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /home/franco/seba/spect_dram_tge/piso_tge.v
  %
  %

  this_block.setTopLevelLanguage('Verilog');

  this_block.setEntityName('piso_tge');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('i_parallel').width ~= 1024);
      this_block.setError('Input data type for port "i_parallel" must have width=1024.');
    end
  ...
  this_block.addGeneric('INPUT_SIZE','integer','1024');
