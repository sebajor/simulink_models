...
function piso_dram_config(this_block)

  % Revision History:
  %
  %   09-Dec-2020  (07:24 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /home/franco/seba/frb_dram/dedisp_dram/piso_dram.v
  %
  %

  this_block.setTopLevelLanguage('Verilog');

  this_block.setEntityName('piso_dram');
  ...
  o_serial_port.setType('UFix_8_0');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('i_parallel').width ~= 288);
      this_block.setError('Input data type for port "i_parallel" must have width=288.');
    end
  ...
  this_block.addGeneric('INPUT_SIZE','integer','288');
  this_block.addGeneric('OUTPUT_SIZE','integer','8');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  dir = '/home/seba/Workspace/simulink_models/DRAM/ROACH2/4bit_dram_agc/hdl_codes';  
