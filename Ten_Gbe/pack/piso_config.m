...
function piso_config(this_block)
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('/home/seba/Workspace/simulink_models/Ten_Gbe/pack/bram_infer.v')
  this_block.addFile('/home/seba/Workspace/simulink_models/Ten_Gbe/pack/piso.v');
