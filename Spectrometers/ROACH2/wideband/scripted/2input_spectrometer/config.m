...
%fft shift value
const_name = strcat(model_name, '/Constant2');
...
set_param(strcat(model_name, '/Delay36'), 'latency', int2str(pow_add_lat+pow_mult_lat));
set_param(strcat(model_name, '/Delay26'), 'latency', int2str(pow_add_lat+pow_mult_lat));
...
%acclen_ctrl
acc_ctrl_name = strcat(model_name, '/acc_cntrl0');
...
%bram counter
set_param(strcat(model_name, '/Counter3'), 'n_bits', int2str(fft_size-4));
